...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🎬 Mᴏᴠɪᴇ Update', url='https://t.me/+9wxEvENMP61hYzE8')
                ],[
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('🪅 Movie Update', url="https://t.me/+9wxEvENMP61hYzE8"),
        ...
        k = await client.send_message(chat_id=user,text=f"<b>📕Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files.file_size)}\n\n📂Fɪʟᴇ ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 20 mins to avoid copyrights. Save the link to Somewhere else</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton('⁉️ 𝘏𝘰𝘸 𝘛𝘰 Download ✓ ⁉️', url="https://t.me/c/1531110341/49")
                    ]
                ]
            )
        )
        ...
        for file in files:
            ...
            if not await check_verification(client, message.from_user.id) and VERIFY == True:
                btn = [[
                    ...
                    InlineKeyboardButton("Hᴏᴡ Tᴏ Vᴇʀɪғʏ", url="https://t.me/c/1531110341/49")
                ]]
                await message.reply_text(
